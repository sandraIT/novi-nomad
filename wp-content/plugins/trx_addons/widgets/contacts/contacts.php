...
class trx_addons_widget_contacts extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		set_query_var('trx_addons_args_widget_contacts', array_merge($args, compact('title', 'logo', 'logo_retina', 'description', 'content', 'email', 'address', 'phone', 'socials', 'googlemap', 'googlemap_height', 'googlemap_position')));
