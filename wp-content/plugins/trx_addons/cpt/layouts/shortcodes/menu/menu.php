...
if ( !function_exists( 'trx_addons_sc_layouts_menu' ) ) {
	function trx_addons_sc_layouts_menu($atts, $content=null){	
		...
		ob_start();
		set_query_var('trx_addons_args_sc_layouts_menu', $atts);
		if (($fdir = trx_addons_get_file_dir('cpt/layouts/shortcodes/menu/tpl.'.trx_addons_esc($atts['type']).'.php')) != '') { include $fdir; }
		else if (($fdir = trx_addons_get_file_dir('cpt/layouts/shortcodes/menu/tpl.default.php')) != '') { include $fdir; }
