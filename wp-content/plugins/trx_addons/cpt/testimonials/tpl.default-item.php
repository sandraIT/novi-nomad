...
<div class="sc_testimonials_item">
    ...
    <div class="sc_testimonials_item_author">
        <div class="sc_testimonials_item_author_avatar"><?php the_post_thumbnail( apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('testimonials'), 'testimonials-default'), array('alt' => get_the_title()) ); ?></div>
    </div>
        <?php } ?>
