...
?>
<div class="sc_team_item <?php
    if (isset($args['inverse']) && ($args['inverse']==1)) {
        echo "sc_team_item_inverse";
    }
?>">
	<?php
	// Featured image
	set_query_var('trx_addons_args_featured', apply_filters('trx_addons_filter_args_featured', array(
		...
		'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('team-short'), 'team-short'),
