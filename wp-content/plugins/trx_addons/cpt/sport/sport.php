...
if ( ($fdir = trx_addons_get_file_dir("cpt/sport/sport.competitions.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/sport/sport.rounds.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/sport/sport.matches.php")) != '') { include_once $fdir; }
if ( ($fdir = trx_addons_get_file_dir("cpt/sport/sport.players.php")) != '') { include_once $fdir; }
...
if (!function_exists('trx_addons_cpt_sport_options')) {
	add_action( 'trx_addons_filter_options', 'trx_addons_cpt_sport_options');
...
if ( !function_exists( 'trx_addons_cpt_sport_load_scripts_front' ) ) {
	...
	function trx_addons_cpt_sport_load_scripts_front() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-cpt_sport', trx_addons_get_file_url('cpt/sport/sport.css'), array(), null );
			wp_enqueue_script('trx_addons-cpt_sport', trx_addons_get_file_url('cpt/sport/sport.js'), array('jquery'), null, true );
		}
	}
}
...
if ( !function_exists( 'trx_addons_cpt_sport_load_scripts_admin' ) ) {
	...
	function trx_addons_cpt_sport_load_scripts_admin() {
		wp_enqueue_script('trx_addons-cpt_sport', trx_addons_get_file_url('cpt/sport/sport.admin.js'), array('jquery'), null, true );
	}
}
...
if ( !function_exists( 'trx_addons_cpt_sport_refresh_list_competitions' ) ) {
	add_filter('trx_addons_filter_refresh_list_competitions', 'trx_addons_cpt_sport_refresh_list_competitions', 10, 2);
	function trx_addons_cpt_sport_refresh_list_competitions($list, $sport) {
...
if ( !function_exists( 'trx_addons_cpt_sport_refresh_list_rounds' ) ) {
	add_filter('trx_addons_filter_refresh_list_rounds', 'trx_addons_cpt_sport_refresh_list_rounds', 10, 2);
	function trx_addons_cpt_sport_refresh_list_rounds($list, $competition) {
...
if ( !function_exists( 'trx_addons_sc_matches' ) ) {
	function trx_addons_sc_matches($atts, $content=null) {	
		...
		ob_start();
		set_query_var('trx_addons_args_sc_matches', $atts);
		if (($fdir = trx_addons_get_file_dir('cpt/sport/tpl.sc_matches.'.trx_addons_esc($atts['type']).'.php')) != '') { include $fdir; }
		else if (($fdir = trx_addons_get_file_dir('cpt/sport/tpl.sc_matches.default.php')) != '') { include $fdir; }
...
if ( !function_exists( 'trx_addons_sc_points' ) ) {
	function trx_addons_sc_points($atts, $content=null) {	
		...
		ob_start();
		set_query_var('trx_addons_args_sc_points', $atts);
		if (($fdir = trx_addons_get_file_dir('cpt/sport/tpl.sc_points.'.trx_addons_esc($atts['type']).'.php')) != '') { include $fdir; }
		else if (($fdir = trx_addons_get_file_dir('cpt/sport/tpl.sc_points.default.php')) != '') { include $fdir; }
		$output = ob_get_contents();
		ob_end_clean();
