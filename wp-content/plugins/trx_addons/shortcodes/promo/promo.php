			...
			"params" => array_merge(
				...
				array(
                    ...
                    array(
                        ...
                        "heading" => esc_html__("Add banner", 'trx_addons'),
                        "description" => wp_kses_data( __("Add banner in the promo block", 'trx_addons') ),
                        'edit_field_class' => 'vc_col-sm-6',
                        'dependency' => array(
                            'element' => 'type',
                            'value' => 'default'
                        ...
                        "std" => "0",
                        "value" => array(esc_html__("Add banner", 'trx_addons') => "1" ),
                        "type" => "checkbox"
                    ),
                    array(
                        "param_name" => "banner_text",
                        "heading" => esc_html__("Banner text", 'trx_addons'),
                        "description" => wp_kses_data( __("Caption for the banner", 'trx_addons') ),
                        'dependency' => array(
                            'element' => 'add_banner',
                            'value' => "1"
                        ),
