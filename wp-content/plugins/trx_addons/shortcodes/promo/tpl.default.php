...
?>><?php
	...
	if (!empty($args['image'])) {
        ...
        if (!empty($args['add_banner'])&&$args['add_banner']==1) {
            ?><div class="sc_promo_banner_wrap"><div class="sc_promo_banner"><?php trx_addons_show_layout($args['banner_text'])?></div></div> <?php
        }?></div><?php
	}
