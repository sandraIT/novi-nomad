					...
					array(
						...
						array(
							...
							'params' => array_merge(array(
                                    ...
                                    array(
                                        "param_name" => "with_caption",
                                        "heading" => esc_html__("Add caption", 'trx_addons'),
                                        "description" => wp_kses_data( __("Add caption to the social icon", 'trx_addons') ),
                                        "admin_label" => true,
                                        'edit_field_class' => 'vc_col-sm-6',
                                        "std" => "0",
                                        "value" => array(esc_html__("Add caption", 'trx_addons') => "1" ),
                                        "type" => "checkbox"
                                    ),
                                    array(
                                        'type' => 'textfield',
                                        ...
                                        'admin_label' => true,
                                        'edit_field_class' => 'vc_col-sm-6',
                                        'description' => esc_html__( 'Caption of the social icon', 'trx_addons' ),
                                        'dependency' => array(
                                            'element' => 'with_caption',
                                            'value' => '1',
                                        ),
                                    ),
