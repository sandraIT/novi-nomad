    ...
    <div class="sc_countdown_content sc_item_content">
    	...
    	<div class="sc_countdown_inner"><?php
			...
			?><div class="sc_countdown_item sc_countdown_days"><?php
				...
				?>
				<span class="sc_countdown_digits"><span></span><span></span><span></span><label class="sc_countdown_label"><?php esc_html_e('Days', 'trx_addons'); ?></label></span>
			 </div><?php
			...
			?><div class="sc_countdown_item sc_countdown_hours"><?php
				...
				?>
				<span class="sc_countdown_digits"><span></span><span></span><label class="sc_countdown_label"><?php esc_html_e('Hours', 'trx_addons'); ?></label></span>
			</div><?php
			...
			?><div class="sc_countdown_item sc_countdown_minutes"><?php
				...
				?>
				<span class="sc_countdown_digits"><span></span><span></span><label class="sc_countdown_label"><?php esc_html_e('Minutes', 'trx_addons'); ?></label></span>
			</div><?php
			...
			?><div class="sc_countdown_item sc_countdown_seconds"><?php
				...
				?>
				<span class="sc_countdown_digits"><span></span><span></span><label class="sc_countdown_label"><?php esc_html_e('Seconds', 'trx_addons'); ?></label></span>
			</div><?php
